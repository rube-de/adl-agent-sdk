...
from .models import VERDICT_TESTS_PASSING, AppConfig, DevResult, Issue, fence_untrusted, has_verdict_line
...
async def run_agent_team(
    ...
    tests_passing = has_verdict_line(output, VERDICT_TESTS_PASSING)
